...
public class BeaverController : MonoBehaviour {
	...
	void Start () {
		...
		myHeight = GetComponent<Collider2D> ().bounds.extents.y;
	...
	void patrol(){
		...
		Vector2 lineCastPos2 = transform.position;
		Debug.DrawLine(lineCastPos2, lineCastPos2 - transform.right.toVector2() * .5f);
